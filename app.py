...
app = Flask(__name__)
model = joblib.load(r"E:\Students Mark Prediction\Student mark Predictor Deployment\student_mark_predictor.pkl")
...
def predict():
    ...
    return render_template('index.html', prediction_text = 'You will get [{}%] marks, when you do study for [{}] hours per day'.format(output, int(features_value[0])))
